...
class OverlapGATv2(nn.Module):
    def __init__(self, height=64, width=900, channels=5, norm_layer=None, use_transformer=True):
        ...
        self.gat_conv1 = GATv2Conv(256, 256, heads=4, residual=True, dropout=0.2)
        self.gat_conv2 = GATv2Conv(256, 512, heads=4, residual=True, dropout=0.2)
        self.gat_conv3 = GATv2Conv(512, 512, heads=4, residual=True, dropout=0.2)
