...
trainer_arg.add_argument('--train_pipeline', type=str, default='OverlapTransformer_ViT') 
...
misc_arg.add_argument('--experiment_name', type=str, default='OverlapTransformer_ViT_torch')  ##############
