...
data_arg.add_argument('--kitti_dir', type=str, default='/data/datasets/kitti/dataset/',
...
data_arg.add_argument('--kitti_data_split', type=dict, default={
    'train': [0, 1, 3, 4, 5, 6, 7, 9, 10],
    'val': [2],
    'test': [8]
})

data_arg.add_argument('--mulran_dir', type=str,
                      default='/data/datasets/MulRan/', help="Path to the MulRan dataset")
...
data_arg.add_argument('--gm_dir', type=str,
                      default='/data/datasets/gm_datasets', help="Path to the gm dataset")
...
misc_arg.add_argument('--experiment_name', type=str, default='OverlapTransformer_resnet_org')  ##############
