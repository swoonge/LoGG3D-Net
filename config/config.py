...
opt_arg.add_argument('--base_learning_rate', type=float, default=1e-3) # 5e-6 ##############
...
if __name__ == "__main__":
    cfg = get_config()
    dconfig = vars(cfg)
    misc_args = {arg.dest: getattr(cfg, arg.dest) for arg in parser._action_groups[5]._group_actions}
    print(misc_args)
