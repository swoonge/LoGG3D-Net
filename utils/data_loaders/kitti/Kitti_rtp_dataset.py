...
from utils.data_loaders.kitti.kitti_dataset import KittiTupleDataset
from utils.data_utils.utils import *

class KittirtpCoordinateTupleDataset(KittiTupleDataset):
    r"""
    ...
    def __init__(self,
        ...
        self.logger.info("KittiSparseTupleDataset")
...
def test_datasets():
    ...
    kitti_sparse_tuple_dataset = KittiSparseTupleDataset(phase='train', config=config)
    ...
    kitti_point_sparse_tuple_dataset = KittiPointSparseTupleDataset(phase='train', config=config)
